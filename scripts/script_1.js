...
0x42F10Bb701ed230222aC6F748320040A0e3ddfAD`;
        ...
        const startTime = getTimestamp('Mon, August 14, 2023 16:40');
        const endTime = getTimestamp('Mon, August 14, 2023 17:05');

        // set time buy 
        await cloudbasePresale.setBuyTime(startTime, endTime);

        const TGE = getTimestamp('Mon, August 14, 2023 17:10');
        const vest1 = getTimestamp('Mon, August 14, 2023 17:13');
        const vest2 = getTimestamp('Mon, August 14, 2023 17:16');
        const timeVests = [TGE,vest1,vest2];
